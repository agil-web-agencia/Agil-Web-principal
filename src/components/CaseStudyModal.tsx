...
export default function CaseStudyModal() {
  ...
  return (
    <AnimatePresence>
      <div className="fixed inset-0 z-[130] flex items-center justify-center p-2 sm:p-6 overflow-y-auto">
        {/* Backdrop */}
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        <motion.div
          ...
          className="relative w-full max-w-5xl max-h-[92vh] glass-panel border border-white/15 bg-[#0d0d12]/95 rounded-3xl shadow-2xl z-10 overflow-hidden flex flex-col my-auto"
        >
          {/* Header Bar */}
          <div className="sticky top-0 z-30 flex items-center justify-between px-6 sm:px-8 py-4 border-b border-white/10 bg-[#0d0d12]/90 backdrop-blur-xl">
